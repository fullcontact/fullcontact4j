...
public final class OkUrlFactory implements URLStreamHandlerFactory, Cloneable {
  ...
  static final Comparator<String> FIELD_NAME_COMPARATOR =
      (a, b) -> {
   ...
   *
   * <p>This code configures OkHttp to handle all HTTP and HTTPS connections created with {@link
  ...
  static final class OkHttpURLConnection extends HttpURLConnection implements Callback {
    ...
    private Call buildCall() throws IOException {
      ...
      // Use a separate dispatcher so that limits aren't impacted. But use the same executor
      // service!
      ...
      this.outputStream =
          new OutputStream() {
            ...
            public void write(byte[] source, int offset, int byteCount) throws IOException {
              ...
              if (expectedContentLength != -1L
                  && bytesReceived + byteCount > expectedContentLength) {
