...
public class NameDeduceRequest extends FCRequest<NameResponse> {
    ...
    public static class Builder extends BaseBuilder<NameDeduceRequest> {
        ...
        public Builder email(String email) {
            params.put(Constants.PARAM_NAME_EMAIL, email);
            return this;
        }

        public Builder username(String username) {
            params.put(Constants.PARAM_NAME_USERNAME, username);
            return this;
        }
        ...
        protected void validate() {
            String email = params.get(Constants.PARAM_NAME_EMAIL);
            String username = params.get(Constants.PARAM_NAME_USERNAME);
